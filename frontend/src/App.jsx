...
const INITIAL_CLIENTS = [
  { id: 1, ice: '000000000000001', name: 'CLIENT DEMO ALPHA', address: 'Adresse exemple, Marrakech', phone: '+212600000001', email: 'alpha@example.test', encours: 0, limiteCredit: 50000 },
  { id: 2, ice: '000000000000002', name: 'CLIENT DEMO BETA', address: 'Adresse exemple, Casablanca', phone: '+212600000002', email: 'beta@example.test', encours: 0, limiteCredit: 200000 },
];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const allowedByRole = {
      ...
      admin: ['home', 'received_documents', 'chiffrage', 'catalogue', 'stock', 'clients', 'pipeline', 'echeancier',
        ...
        'compta_journaux_salaires', 'compta_journaux_tva', 'magasin_reception', 'magasin_preparation',
  ...
  const [leads, setLeads] = useState(() => ls.getJSON('is_leads', [
    { id: 1, client: 'CLIENT DEMO ALPHA', value: 4480, stage: 'Négociation', probability: 80, ref: 'REF-DEMO-1' },
    { id: 2, client: 'CLIENT DEMO BETA', value: 1200, stage: 'Devis Envoyé', probability: 50, ref: 'REF-DEMO-2' },
  ]));
  ...
  const S = {
    input: { background: 'transparent', border: 'none', outline: 'none', fontFamily: 'inherit', fontSize: 'inherit', color: 'inherit', width: '100%', padding: '1px 2px', margin: 0 },
